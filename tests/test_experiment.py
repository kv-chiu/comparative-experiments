...
def test_experiment_comparator_export_results_with_multiple_experiments():
    ...
    assert results["Mock Experiment 1"]["MSE"] == 4.666666666666667, "The metric value was not exported correctly."
    assert results["Mock Experiment 1"]["RMSE"] == 2.160246899469287, "The metric value was not exported correctly."
    assert results["Mock Experiment 1"]["MAE"] == 2.0, "The metric value was not exported correctly."
    assert results["Mock Experiment 1"]["R2"] == -0.75, "The metric value was not exported correctly."
    assert results["Mock Experiment 2"]["MSE"] == 0.0, "The metric value was not exported correctly."
    assert results["Mock Experiment 2"]["RMSE"] == 0.0, "The metric value was not exported correctly."
    assert results["Mock Experiment 2"]["MAE"] == 0.0, "The metric value was not exported correctly."
    assert results["Mock Experiment 2"]["R2"] == 1.0, "The metric value was not exported correctly."
    assert results["Mock Experiment 3"]["MSE"] == 4.666666666666667, "The metric value was not exported correctly."
    assert results["Mock Experiment 3"]["RMSE"] == 2.160246899469287, "The metric value was not exported correctly."
    assert results["Mock Experiment 3"]["MAE"] == 2.0, "The metric value was not exported correctly."
    assert results["Mock Experiment 3"]["R2"] == -0.75, "The metric value was not exported correctly."
